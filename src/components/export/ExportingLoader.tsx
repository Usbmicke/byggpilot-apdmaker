...
const ExportingLoader: React.FC = () => {
    return (
        <div className="absolute inset-0 bg-zinc-950/95 z-50 flex items-center justify-center backdrop-blur-sm">
            <div className="construction-loader">
                <div className="relative">
                    ...
                    <svg className="hammer-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.5 5.5L18.5 9.5" stroke="#a1a1aa" strokeWidth="2" strokeLinecap="round" />
