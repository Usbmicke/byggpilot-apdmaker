    ...
    return (
        <header className="bg-slate-800 border-b border-slate-700 p-2 sm:p-3 flex items-center justify-between z-30 relative shadow-md h-[72px]">
            ...
            <div className="flex items-center justify-end gap-1 sm:gap-2">
                ...
                {/* Main Action Buttons - Icons visible, text appears on larger screens */}
                ...
                <button onClick={toggleLegend} disabled={!background} className="p-2 rounded-md hover:bg-slate-700 text-slate-300 transition-colors disabled:opacity-40 disabled:cursor-not-allowed hidden sm:flex" title="Visa/Dölj Projektinformation och Förteckning">
