...
export const logistikCategory: { name: string; items: LibraryItem[] } = {
    name: "Logistik",
    items: [
        { type: 'container-10', name: 'Container 10m³', icon: <Container10Icon />, iconUrl: createIcon(ContainerSVG10), initialProps: UNIFORM_SIZE },
        { type: 'container-30', name: 'Container 30m³', icon: <Container30Icon />, iconUrl: createIcon(ContainerSVG30), initialProps: UNIFORM_SIZE },
        { type: 'tippcontainer', name: 'Tippcontainer (Öppen)', icon: <TippContainerIcon />, iconUrl: createIcon(TippContainerSVG), initialProps: UNIFORM_SIZE },
        { type: 'tippcontainer-stangd', name: 'Tippcontainer (Stängd)', icon: <TippContainerStangdIcon />, iconUrl: createIcon(TippContainerStangdSVG), initialProps: UNIFORM_SIZE },
        { type: 'upplag', name: 'Materialupplag', icon: <UpplagIcon />, iconUrl: createIcon(UpplagSVG), initialProps: UNIFORM_SIZE },
        { type: 'lossning', name: 'Lossningszon', icon: <LossningIcon />, iconUrl: createIcon(LossningSVG), initialProps: UNIFORM_SIZE },
        { type: 'vandplan', name: 'Vändplan', icon: <VandplanIcon />, iconUrl: createIcon(VandplanSVG), initialProps: UNIFORM_SIZE },
        { type: 'infart', name: 'Infart', icon: <InfartIcon />, iconUrl: createIcon(InfartSVG), initialProps: UNIFORM_SIZE },
        { type: 'parkering', name: 'Parkering', icon: <ParkeringIcon />, iconUrl: createIcon(ParkeringSVG), initialProps: UNIFORM_SIZE },
    ]
};
