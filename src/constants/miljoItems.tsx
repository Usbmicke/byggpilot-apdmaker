...
const MILJOSTATION_SIZE = { width: 1.5, height: 1.0 }; // Reduced to symbolic size
const SMALL_SIZE = { width: 1.0, height: 1.0 };
// --- Icon Components ---
...
export const miljoCategory: { name: string; items: LibraryItem[] } = {
    name: "Miljö",
    items: [
        { type: 'miljostation', name: 'Miljöstation', icon: <MiljostationIcon />, iconUrl: 'src/assets/ikoner/miljostation.png', initialProps: MILJOSTATION_SIZE },
        { type: 'farligt-avfall', name: 'Farligt avfall', icon: <FarligtAvfallIcon />, iconUrl: createIcon(FarligtAvfallSVG), initialProps: SMALL_SIZE },
        { type: 'oil-separator', name: 'Oljeavskiljare', icon: <OljeavskiljareIcon />, iconUrl: createIcon(OljeavskiljareSVG), initialProps: SMALL_SIZE },
    ]
};
