...
const SHED_SIZE = { width: 84, height: 29 }; // ~8.4m x 2.9m (Standard scale 1px=0.1m)
const WC_SIZE = { width: 30, height: 30 }; // ~3m x 3m
...
export const etableringCategory: { name: string; items: LibraryItem[] } = {
    ...
    items: [
        ...
        { type: 'kontor', name: 'Kontor', icon: <KontorIcon />, iconUrl: createIcon(KontorSVG), initialProps: SHED_SIZE },
